<?php
if(!defined("A0(57%?<Fr@4**&__APPLICATIONS___K#2*&(J^8392$()8347&^"))
{
    ...
    .loading_con
    {
        ...
        <div class="allContner">
            ...
            <div class="main_head_con main_filter_approval">
                <div class="myactv myper">Success Applications</div>
        ...
        <script src="admin.js.all.files/ui.loan.partner.app.js"></script>
    </body>
</html>
<?php
