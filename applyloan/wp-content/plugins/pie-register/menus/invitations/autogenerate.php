  ...
  <ul class="bg-white clearfix invite-form">
      ...
      <li class="clearfix">
        <div class="fields">
          <div  class="cols-2">
            <h3>
              <?php _e("Code Length","pie-register");?>
            </h3>
          </div><!-- cols-3 -->
         <div class="cols-3">
            <input disabled style="float:left;" value="<?php echo (isset($this->pie_post_array['invitation_code_length'])?$this->pie_post_array['invitation_code_length']:''); ?>" type="number" min="5" max="10" name="invitation_code_length" class="input_fields2"/>
            <span style="text-align:left;" class="note pie_usage_note">
            <?php _e("Enter the length of code. Code can be minimum 5 characters and maximum 10 characters long.","pie-register");?>
            </span>
          </div><!-- cols-3 -->
        </div>
      </li>
      <li class="clearfix code_desc">
        <div class="fields">
          <div class="cols-2">
            <h3>
              <?php _e("Code Description","pie-register");?>
            </h3>
          </div><!-- cols-3 -->
          <div class="cols-3">
            ...
            <?php _e("Enter a short description.","pie-register");?>
            </span>
          </div><!-- cols-3 -->
        </div>
      </li>
