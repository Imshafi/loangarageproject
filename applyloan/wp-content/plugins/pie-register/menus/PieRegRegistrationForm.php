      ...
      <tr>
        ...
        <td class="column-title"><strong><?php echo esc_html($option['Title']); ?></strong>
          <div class="piereg-actions">
            ...
            <span class="edit"><a class="underlinenone" href="<?php echo esc_url( get_permalink($piereg['alternate_register']).'/?pr_preview=1&form_id='.$option['Id'].'&prFormId='. $option['Id'] ) ?>" target="_blank" title="Preview this form">Preview</a> </span>
          </div>
        </td>
