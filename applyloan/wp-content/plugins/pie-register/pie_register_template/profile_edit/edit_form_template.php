...
class Edit_form_template extends Edit_form
{
	...
	function addPassword(  $noPasswordField=false ){
		...
		$data = "";	
		$data .= '<div class="fieldset"><label>'.__("Current Password","pie-register").'</label><div '.$fclass.'><input id="old_password_'.$this->id.'" type="password" class="input_fields" value="" name="old_password" autocomplete="off"><span class="show-hide-password-innerbtn confirm-pass-eye-reg eye"></span></div></li>';
		...
		if( isset($this->field['password_generator']) && $this->field['password_generator'] != "" ){
			...
			if ( !$noPasswordField )
			{
				...
				$data .= '<li class="fields pageFields_'.$this->pages.' '.$topclass.'">';
					$data .='<div class="fieldset">'.'<label for="'.$this->id.'">'. __($label,"pie-register").'</label>';
	...
	function addDate()
	{
		...
		if($this->field['date_type'] == "datefield")
		{
			...
			$data .= '<div class="piereg_time date_format_field">
				  <div class="time_fields">
					<input '.$this->read_only.' id="mm_'.$this->id.'" name="'.$this->name.'[date][mm]" maxlength="2" type="text" class="'.$this->addClass("input_fields",array("custom[month]")).'" '.$this->addValidation().' value="'.((isset($val['date']['mm']))?$val['date']['mm']:"").'"  data-type="date">
					<label>'.__("MM","pie-register").'</label>
				  </div>
				  <div class="time_fields">
					<input '.$this->read_only.' id="dd_'.$this->id.'" name="'.$this->name.'[date][dd]" maxlength="2"  type="text" class="'.$this->addClass("input_fields",array("custom[day]")).'" '.$this->addValidation().' value="'.((isset($val['date']['dd']))?$val['date']['dd']:"").'" data-type="date">
					<label>'.__("DD","pie-register").'</label>
				  </div>
				  <div class="time_fields">
					<input '.$this->read_only.' id="yy_'.$this->id.'" name="'.$this->name.'[date][yy]" maxlength="4"  type="text" class="'.$this->addClass("input_fields",array("custom[year]")).'" '.$this->addValidation().' value="'.((isset($val['date']['yy']))?$val['date']['yy']:"").'"  data-type="date">
			...
			else if($this->field['date_format']=="yy/mm/dd" || $this->field['date_format']=="yy.mm.dd")
			{
				$data .= '<div class="piereg_time time date_format_field">
				 <div class="time_fields">
					<input '.$this->read_only.' value="'.(isset($val['date']['yy'])?$val['date']['yy']:"").'" id="yy_'.$this->id.'" name="'.$this->name.'[date][yy]" maxlength="4"  type="text" class="'.$this->addClass("input_fields",array("custom[year]")).'" data-type="date">
					<label>'.__("YYYY","pie-register").'</label>
				  </div>
				  <div class="time_fields">
					<input '.$this->read_only.' value="'.(isset($val['date']['mm'])?$val['date']['mm']:"").'" id="mm_'.$this->id.'" name="'.$this->name.'[date][mm]" maxlength="2" type="text" '.$this->addValidation().'  class="'.$this->addClass("input_fields",array("custom[month]")).'" data-type="date">
					<label>'.__("MM","pie-register").'</label>
				  </div>
				  <div class="time_fields">
					<input '.$this->read_only.' value="'.(isset($val['date']['dd'])?$val['date']['dd']:"").'" id="dd_'.$this->id.'" name="'.$this->name.'[date][dd]" maxlength="2"  type="text" class="'.$this->addClass("input_fields",array("custom[day]")).'"  data-type="date">
					<label>'.__("DD","pie-register").'</label>
				  </div>				  
				</div>';	
			}
			else
			{
				$data .= '<div class="piereg_time date_format_field">
				 <div class="time_fields">
				  ...
				  <div class="time_fields">
					<input '.$this->read_only.' value="'.(isset($val['date']['mm'])?$val['date']['mm']:"").'" id="mm_'.$this->id.'" name="'.$this->name.'[date][mm]" maxlength="2" type="text" class="'.$this->addClass("input_fields",array("custom[month]")).'"  data-type="date">
					<label>'.__("MM","pie-register").'</label>
				  </div>	
				  <div class="time_fields">
					<input '.$this->read_only.' value="'.(isset($val['date']['yy'])?$val['date']['yy']:"").'" id="yy_'.$this->id.'" name="'.$this->name.'[date][yy]" maxlength="4"  type="text" '.$this->addValidation().' class="'.$this->addClass("input_fields",array("custom[year]")).'"  data-type="date">
					<label>'.__("YYYY","pie-register").'</label>
				  </div>
				</div>';	
			}
		...
		else if($this->field['date_type'] == "datepicker")
		{
			...
			else
			{
				...
				$data .= '<input readonly id="'.$this->id.'" name="'.$this->name.'[date][]" type="text" class="'.$this->addClass().' date_start" value="'.$val.'"  data-field-visibility-addon="'.( (isset($this->field['enable_read_only'])) && ( ($this->field['enable_read_only'] == "profile") || ($this->field['enable_read_only'] == "profnreg") ) ?"1":"0").'">';
		...
		else if($this->field['date_type'] == "datedropdown")
		{
			if($this->field['date_format']=="mm/dd/yy")
			{
					$data .= '<div class="piereg_time date_format_field">
				  <div class="time_fields">
					<select '.$this->read_only.' id="mm_'.$this->id.'" name="'.$this->name.'[date][mm]" class="'.$this->addClass("").'" '.$this->addValidation().'  data-type="date">
				  ...
				  $data .=
				  '<div class="time_fields">
					<select '.$this->read_only.' id="dd_'.$this->id.'" name="'.$this->name.'[date][dd]" class="'.$this->addClass("").'" '.$this->addValidation().'  data-type="date">
				  ...
				  $data .= '
				  <div class="time_fields">
					<select '.$this->read_only.' id="yy_'.$this->id.'" name="'.$this->name.'[date][yy]" class="'.$this->addClass("").'" '.$this->addValidation().'  data-type="date">
			...
			else if($this->field['date_format']=="yy/mm/dd" || $this->field['date_format']=="yy.mm.dd")
			{
					$data .= '<div class="piereg_time date_format_field">
					 <div class="time_fields">
					<select '.$this->read_only.' id="yy_'.$this->id.'" name="'.$this->name.'[date][yy]" class="'.$this->addClass("").'"  data-type="date">
					  <option value="">'.__("Year","pie-register").'</option>';
					  for($a=((int)date("Y") + 10);$a>=(((int)date("Y"))-100);$a--){
					  	$data .= '<option value="'.$a.'"';
				  ...
				  <div class="time_fields">
				   ...
				   $data .=
				  '<div class="time_fields">
					<select '.$this->read_only.' id="dd_'.$this->id.'" name="'.$this->name.'[date][dd]" class="'.$this->addClass("").'"  data-type="date">
					  <option value="">'.__("Day","pie-register").'</option>';
					  for($a=1;$a<=31;$a++){
					  	$data .= '<option value="'.str_pad($a, 2, "0", STR_PAD_LEFT).'"';
